...
def load_env(cli=False, testsuite=False):  # pragma: no cover
    ...
    if not cli:
        #parser.add_argument('server_host',default='127.0.0.1', help='host to connect for the server')
    ...
    parser.add_argument('--skip-self-test', default=True, action='store_true', help='skip executor self-tests')
    ...
    server_host = getattr(args, 'server_host', 'localhost')
